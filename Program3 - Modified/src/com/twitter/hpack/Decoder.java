...
public final class Decoder {
   ...
   * @param maxHeaderTableSize maxHeaderTableSize
   */
   ...
   * @param headerListener HeaderListener
  ...
  /**
   * Sets Dynamic Table Size
   * @param dynamicTableSize size of the table
   * @throws IOException if IOException
   */
